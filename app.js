...
(function(exports) {
  ...
  var render = function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["h1'"]([ React_DOM.text("Lesson 2 - Actions") ]), React_DOM["p'"]([ React_DOM.text("The state is: "), React_DOM.text(Data_Show.show(Data_Show.showInt)(state)) ]), React_DOM.p([ React_DOM_Props.className("btn-group") ])([ React_DOM.button([ React_DOM_Props.className("btn btn-success"), React_DOM_Props.onClick(function (v2) {
                      return dispatch(Increment.value);
                  }) ])([ React_DOM.text("Increment") ]), React_DOM.button([ React_DOM_Props.className("btn btn-danger"), React_DOM_Props.onClick(function (v2) {
      ...
      return function (v1) {
          return function (v2) {
              if (v instanceof Increment) {
                  return Data_Functor["void"](Control_Monad_Free_Trans.functorFreeT(Control_Coroutine.functorCoTransform)(Control_Monad_Aff.functorAff))(Thermite.modifyState(function (state) {
                      return state + 1 | 0;
                  }));
              };
              ...
              throw new Error("Failed pattern match at Main line 43, column 1 - line 43, column 50: " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
