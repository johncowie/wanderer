...
(function(exports) {
  ...
  var words = (function () {
      ...
      return function ($24) {
          return Data_List.fromFoldable(Data_Foldable.foldableArray)(Data_String_Regex.split(whitespace)(Data_String.toLower(Data_String.trim($24))));
      };
  })();
  ...
  var parseCommand = function ($26) {
      return parseWords(words($26));
  };
  exports["SitUp"] = SitUp;
...
(function(exports) {
  ...
  var update = function (v) {
      return function (v1) {
          if (v instanceof Wanderer_Data_Command.SitUp && v1 instanceof Lying) {
              return {
                  output: "You sit up. The sofa creaks as you adjust your position. You have to squint a bit in the dim light, but you appear to be in a medium-sized living room.",
                  game: Sitting.value
              };
          };
          if (v instanceof Wanderer_Data_Command.SitUp && v1 instanceof Sitting) {
              return {
                  output: "You're already sitting up.",
                  game: Sitting.value
              };
          };
          if (v instanceof Wanderer_Data_Command.SitUp && v1 instanceof Standing) {
              return {
                  output: "You can't sit up if you're standing!",
                  game: Standing.value
              };
          };
          if (v instanceof Wanderer_Data_Command.StandUp && v1 instanceof Lying) {
              return {
                  output: "You need to sit up first before standing. One step at a time!",
                  game: Lying.value
              };
          };
          if (v instanceof Wanderer_Data_Command.StandUp && v1 instanceof Sitting) {
              return {
                  output: "You stand up.",
                  game: Standing.value
              };
          };
          if (v instanceof Wanderer_Data_Command.StandUp && v1 instanceof Standing) {
              return {
                  output: "You're already standing up.",
                  game: Standing.value
              };
          };
          return {
              output: "That didn't make much sense.",
              game: Standing.value
          };
      };
  };
...
(function(exports) {
  ...
  var Wanderer_Data_Room = PS["Wanderer.Data.Room"];        
  var receiveInput = function (game) {
      return function (input) {
          var v = Wanderer_Data_Command.parseCommand(input);
          if (v instanceof Data_Either.Right) {
              return Wanderer_Data_Game.update(v.value0)(game);
          };
          ...
          throw new Error("Failed pattern match at App line 21, column 27 - line 23, column 41: " + [ v.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var submitText = function (r) {
      var v = App.receiveInput(r.game)(r.input);
      return {
          input: "",
          output: v.output,
          game: v.game
  ...
  var render = function (dispatch) {
      return function (v) {
          return function (state) {
              return function (v1) {
                  return [ React_DOM["p'"]([ React_DOM.text(state.output) ]), React_DOM["p'"]([ React_DOM.input([ React_DOM_Props._type("text"), React_DOM_Props.value(state.input), React_DOM_Props.onChange(function (ev) {
  ...
  var performAction = function (v) {
      return function (v1) {
          return function (v2) {
              ...
              throw new Error("Failed pattern match at Main line 55, column 1 - line 55, column 50: " + [ v.constructor.name, v1.constructor.name, v2.constructor.name ]);
          };
      };
  };
  ...
  var initialState = {
      input: "",
      game: App.initialState.game,
      output: App.initialState.output
  };
